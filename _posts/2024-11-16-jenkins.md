...
[devops](/uncategorized/devops/) [java](/software%20engineering/java/) [CICD](/devops/cicd/) [Testing](/testing/testing/) [monorepo](/backend/monorepo/)

[jenkins.code-workspace](file:///D:%5CDocs%20Hp%5CCode-projects%5Cjenkins.code-workspace) 💻
...
# omnivore [jenkins](/jenkins/jenkins/)
{% raw %}
```base
type: list
