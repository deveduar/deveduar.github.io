...
- Sintaxis simple basada en “mustaches” (`{% raw %}{{ }}{% endraw %}`), portable entre lenguajes.
...
## Videos
- [How to implement Mustache with Spring boot - YouTube](https://youtu.be/HUB_KQcEHnA) — [Springboot](/backend/springboot/) [java](/software%20engineering/java/)
- [Code generation with Mustache Templates - YouTube](https://youtu.be/lMhgMhZOueE) — JS  
	- csv, configs, clases, types, converters, api, code from inputs
- [Mustache Templates in Block: A Step-by-Step Tutorial - YouTube](https://youtu.be/uUB8CNvb6lg) — [PHP](/backend/php/)
- [Mastering Mustache and PHP for SPA Development #105 - YouTube](https://youtu.be/B7hIR_Ii_d4) 🔥 [PHP](/backend/php/)
...
- Mantener coherencia semántica:
	- `{% raw %}{{#items}}{% endraw %}` siempre con nombre plural.
