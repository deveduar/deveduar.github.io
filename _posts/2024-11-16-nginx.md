creation date: 2024-11-16 17:03
tags:
  - nginx
  - backend
  - devops
...
* [apache](/backend/apache/) vs [nginx](/uncategorized/nginx/):
...
# 🧩 Plantillas y Configuración Avanzada de [nginx](/uncategorized/nginx/)
...
> Relacionado con [nginx](/uncategorized/nginx/), [proxy](/backend/proxy/), SSL, [Docker](/software%20engineering/docker/), DevOps y [microservicios](/backend/microservicios/).
