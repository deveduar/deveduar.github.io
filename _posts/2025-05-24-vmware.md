...
- Se integra con [Automatizacion y Build](/uncategorized/automatizacion-y-build/) mediante APIs o herramientas como PowerCLI y Ansible.
...
- NSX abstrae y gestiona la [infraestructura de red](/uncategorized/redes/) a nivel de software.  
...
- Integración con soluciones de [ciberseguridad](/uncategorized/ciberseguridad/) para detectar y mitigar amenazas dentro del tráfico este-oeste.
...
## [Automatizacion y Build](/uncategorized/automatizacion-y-build/) con VMware
...
- Incluye **Aria Automation**, **Aria Operations** y **Aria Orchestrator**, que permiten:
	...
	- Integrar flujos CI/CD de [devops](/uncategorized/devops/).  
...
## [ciberseguridad](/uncategorized/ciberseguridad/) en entornos VMware
...
* Facilita la adopción progresiva de [cloud](/uncategorized/cloud/) y contenedores mediante integración con Tanzu y Kubernetes.

---

## Integración con [devops](/uncategorized/devops/) y Contenedores
...
Tanzu representa el puente entre VMware y el mundo de los contenedores y [devops](/uncategorized/devops/).
...
Está diseñada para simplificar el despliegue de entornos híbridos o privados listos para escalar y operar bajo principios de [Automatizacion y Build](/uncategorized/automatizacion-y-build/).
...
* Mayor integración con [cloud](/uncategorized/cloud/) nativas y entornos serverless.
