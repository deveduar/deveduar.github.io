...
- Integración con sistemas de build y automatización como [gulp](/automatizacion%20y%20build/gulp/) y [Automatizacion y Build](/uncategorized/automatizacion-y-build/)
...
- Configura tareas
- Deja el proyecto listo para [Automatizacion y Build](/uncategorized/automatizacion-y-build/)
