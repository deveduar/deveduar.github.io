...
## Descripción general
**Fastify** es un framework de [Backend](/uncategorized/backend/) para [node.js](/backend/node-js/) centrado en el **rendimiento**, la **baja sobrecarga** y la **extensibilidad**. Es una alternativa moderna a Express con mejor manejo de asincronía y validación de esquemas mediante JSON Schema.
